...
public class ManageTABLE {
        ...
        try {
            ...
            if (objCursor != null) {
                ...
                if (objCursor.moveToFirst()) {
                    ...
                    resultString = new String[objCursor.getColumnCount()];
    ...
    public long addCall(String strName_Call,
        ...
        obContentValues.put(COLUMN_Name_Call,strName_Call);
        obContentValues.put(COLUMN_Phone_Call,strPhone_Call);

        return writeSqLiteDatabase.insert(TABLE_callTABLE,null,obContentValues);
